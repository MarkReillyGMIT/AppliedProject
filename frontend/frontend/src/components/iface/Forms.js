...
export default class Forms extends Component {
    ...
    async getWeather() {
        try {
            const api_call = await fetch(`//api.openweathermap.org/data/2.5/weather?q=${this.state.city},${this.state.country}&APPID=4c877f2673f01a25cab9395e71356dad`)
    ...
    async getForecast() {
        const forecast_call = await fetch(`//api.openweathermap.org/data/2.5/forecast?id=${this.state.cityid}&appid=4c877f2673f01a25cab9395e71356dad`)
